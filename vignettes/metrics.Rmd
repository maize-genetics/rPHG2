...
If you want to color bars based additional categorical besides sample ID, you
can pass a `data.frame` object to the parameter `mData`. This will need the
...
I will make a `data.frame` object with following columns, `sample` and 
